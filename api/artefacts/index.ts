...
export default async function handler(
  ...
  try {
    ...
    const { question_id, filename, file_type, url } = req.body;
    ...
    const insertRes = await pool.query(
      `
      INSERT INTO artefacts (id, question_id, filename, file_type, url)
      VALUES ($1, $2, $3, $4, $5)
      RETURNING id, question_id, filename, file_type, url, uploaded_at
      `,
      [artefactId, question_id, filename, file_type, url]
    );
